      ...
      <main style={{ paddingTop: "var(--header-h)", overflow: "hidden" }}>
        ...
        <section style={{
          ...
          <div style={{ position:"absolute", top:0, right:0, width:"50%", height:"100%", zIndex:0, opacity:0.28, pointerEvents:"none" }}>
            <Image src={microsoftFabricImg} alt="Microsoft Fabric Platform" fill sizes="(max-width: 768px) 40vw, 200px"
          ...
          <div className="container" style={{ position:"relative", zIndex:1 }}>
            ...
            <div className="hero-badge" style={{
              ...
              <div style={{ position:"relative", width:"20px", height:"20px" }}>
                <Image src={microsoftFabricImg} alt="Microsoft Fabric" fill sizes="(max-width: 768px) 40vw, 200px" style={{ objectFit:"contain" }} />
              </div>
