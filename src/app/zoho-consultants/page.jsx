export const metadata = {
  title: "Zoho Consultants",
  description: "Zoho Consultants - FI Digital"
};

export default function Page() {
  return (
    <div style={{ paddingTop: "120px", display: "flex", flexDirection: "column", minHeight: "60vh", alignItems: "center", justifyContent: "center" }}>
      <h1 style={{ fontSize: "3rem", fontWeight: "bold", textAlign: "center", marginBottom: "2rem" }}>Zoho Consultants</h1>
