...
export default function ITSoftwareClient() {
  ...
  return (
    <div ref={containerRef} style={{ background: "var(--bg)", minHeight: "100vh" }}>
        ...
        <div className="container" style={{ position: "relative", zIndex: 1, textAlign: "left" }}>
          ...
          <div style={{ maxWidth: "1000px", textAlign: "left" }}>
            <div className="hero-badge" style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", background: "rgba(29, 78, 216, 0.1)", color: "var(--primary)", padding: "0.5rem 1rem", borderRadius: "50px", fontWeight: 700, marginBottom: "1.5rem" }}>
              <Monitor size={16} /> Tech Company Integration
            </div>
            ...
            <h1 className="hero-title" style={{ fontSize: "clamp(2.5rem, 5vw, 4.5rem)", lineHeight: 1.1, fontWeight: 900, color: "var(--text)", letterSpacing: "-0.02em", marginBottom: "2rem", textWrap: "balance" }}>
              Tailored Ecosystems for <br/>
              <span style={{ color: "var(--primary)", fontWeight: 300 }}>IT & Software Teams</span>
            </h1>
            ...
            <div className="hero-subtitle" style={{ display: "grid", gap: "1.5rem", margin: "0 0 3rem 0", maxWidth: "800px" }}>
              <p style={{ fontSize: "clamp(1.1rem, 2vw, 1.25rem)", color: "var(--text-muted)", lineHeight: 1.7, margin: 0, textWrap: "balance" }}>
                Zoho for IT & Software is tailored to help software companies improve their business processes and customer relationships. Today, an increasing number of IT & Software providers in Australia trust Zoho range of applications as well software to boost their operations and revenue.
              </p>
              ...
              <p style={{ fontSize: "clamp(1.1rem, 2vw, 1.25rem)", color: "var(--text-muted)", lineHeight: 1.7, margin: 0, paddingLeft: "1.5rem", borderLeft: "4px solid var(--primary)" }}>
                Zoho CRM implementation & integration aids IT & Software businesses to manage their marketing and sales, while automatically capturing leads and enquiries from their website.
              </p>
            </div>
        ...
        <div className="container" style={{ maxWidth: "1000px", textAlign: "center" }}>
          <div className="reveal">
            <h2 className="section-title" style={{ fontSize: "2.5rem", fontWeight: 900, marginBottom: "2rem", lineHeight: 1.2 }}>
              Best Zoho Implementation Services <br/>for IT & Software Companies
            </h2>
            <div style={{ background: "var(--bg)", border: "1px solid var(--border)", borderRadius: "24px", padding: "3.5rem", boxShadow: "0 20px 40px rgba(0,0,0,0.02)", textAlign: "left" }}>
              <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                <p style={{ fontSize: "1.15rem", color: "var(--text)", lineHeight: 1.8, margin: 0 }}>
                  Zoho applications for IT companies help them automate their workflows while improving their sales processes. It enables to build a highly efficient system and dashboard for managing and nurturing leads.
                </p>
                <div style={{ padding: "1.5rem", background: "rgba(29, 78, 216, 0.05)", borderLeft: "4px solid var(--primary)", borderRadius: "0 16px 16px 0", marginTop: "1rem" }}>
                  <p style={{ color: "var(--text-muted)", fontWeight: 500, margin: 0, fontSize: "1.1rem", lineHeight: 1.7 }}>
                    IT & Software organizations use Zoho apps for acquiring detailed and vital information regarding sales cycle, capture leads, as well as forecast their revenue.
                  </p>
               </div>
               <p style={{ fontSize: "1.15rem", color: "var(--text-muted)", lineHeight: 1.8, margin: 0, marginTop: "1rem" }}>
                 Zoho apps implementation services also help them to extend customer support online and speed up their response time.
               </p>
              </div>
            </div>
          </div>
        ...
        <div className="container" style={{ maxWidth: "1250px" }}>
          ...
          <div className="reveal" style={{ textAlign: "center", marginBottom: "4rem" }}>
            ...
            <p style={{ fontSize: "1.15rem", color: "var(--text-muted)", margin: "0 auto", maxWidth: "800px", lineHeight: 1.8 }}>
              FI Digital is an Authorized Partner for Zoho implementation and integration services. We provide custom Zoho application implementation to IT & Software companies of all scales and sizes, enabling them to scale their business to the next level.
            </p>
          </div>

          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "2rem" }}>
             {[
               { title: "Targeted Objectives", desc: "We offer the best in class Zoho consultancy and implementation that helps IT & Software companies to fulfil their business objectives.", icon: Briefcase, color: "#3B82F6" },
               { title: "Profitability & Growth", desc: "Our Zoho experts specialize in implementing all Zoho products that help IT & Software organizations bolster their growth and profits.", icon: TrendingUp, color: "#10B981" },
               { title: "Agile Customer Support", desc: "Our Zoho consulting, training & implementation for IT companies help them in building long-term customer relationship through consistent delivery of value and agile customer support.", icon: HeartHandshake, color: "#F59E0B" },
               { title: "Competitive Offerings", desc: "Our Zoho application implementation services are competitively priced to meet your exact requirements.", icon: BadgeDollarSign, color: "#8B5CF6" },
               { title: "On-Time Fulfillment", desc: "We offer On-time project delivery using time-tested techniques and processes.", icon: Clock, color: "#EF4444" }
             ].map((item, i) => (
      ...
      {/* ══ SECTION 3: SLA OVERVIEW ══════════════ */}
      <section className="section" style={{ background: "var(--bg-secondary)", padding: "80px 1.5rem", borderTop: "1px solid var(--border)" }}>
        <div className="container" style={{ maxWidth: "900px", textAlign: "center" }}>
          <div className="reveal">
            <p style={{ fontSize: "1.25rem", color: "var(--text)", fontWeight: 700, margin: 0, lineHeight: 1.8 }}>
              Whether you are planning to manage your client support requests or you want to improve your SLA and contract management, Zoho implementation is ideal for your IT & Software business!
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="cta" style={{ padding: '120px 1.5rem', background: '#1d4ed8', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ maxWidth: '900px', textAlign: 'center', position: 'relative', zIndex: 2 }}>
          ...
          <h2 style={{ fontSize: '3rem', fontWeight: 900, color: 'white', marginBottom: '3rem', letterSpacing: '-0.02em', lineHeight: 1.2, margin: "0 auto 3rem auto" }}>
             Get in touch with us to know more about our Zoho solutions for IT & Software companies!
          </h2>
