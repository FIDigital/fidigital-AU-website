    ...
    <>
      <JsonLd
        data={buildBreadcrumb([
          ...
          { name: "Healthcare & Aged Care", path: "/industries/healthcare-aged-care" },
        ])}
      />
      <div className="min-h-screen pt-32 pb-20 px-4 md:px-8 bg-neutral-900 text-white flex flex-col items-center justify-center">
        ...
        <p className="text-lg text-neutral-400 max-w-2xl text-center">
          This is a placeholder for the Healthcare Aged Care page, part of the new digital transformation architecture.
        </p>
      </div>
    </>
  );
